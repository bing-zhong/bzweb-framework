package com.abing.springbootinit.spi.utils.redisson.aop;

import com.abing.springbootinit.spi.utils.redisson.LockManager;
import com.abing.springbootinit.spi.utils.redisson.RateLimitManager;
import com.abing.springbootinit.spi.utils.redisson.SpELUtils;
import com.abing.springbootinit.spi.utils.redisson.annotation.RedissonLock;
import com.abing.springbootinit.spi.utils.redisson.annotation.RedissonRateLimit;
...
public class RedissonOpsAop {
    ...
    @Around("@annotation(com.abing.springbootinit.spi.utils.redisson.annotation.RedissonLock)")
    ...
    @Around("@annotation(com.abing.springbootinit.spi.utils.redisson.annotation.RedissonRateLimit)")
